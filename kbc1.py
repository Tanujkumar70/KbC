Questions = [
    '''
    Q1) Arrange these landmark events in Indiaâ€™s Space Programme in Chronological order
   ...
   ''',
    ...
    ''',
    '''
    Q4) Which of these substances is composed of only two elements â€“ hydrogen & oxygen?
    A.	Water
    B.	Salt
    C.	Sugar
    D.	Blood
    ''',
    '''
    Q5) â€œNabhah Sparsham Deeptamâ€, the motto of India Air Force, is taken from which ancient work?
    A.  Garuda Purana
    B.  Valmiki Ramayan
    C.  Bhagwad Gita
    D.  Mundaka Upnishad
    ''',
    '''    
     Q6) In 2018, which Indian â€“ born person won the Field Medal, often called Noble Prize for Mathematics?
    A.	Manjul Bhargava
    B.	Akshay Venkatesh
    ...
    ''',
    '''
    Q7) Which of these stateâ€™s capital is farthest east?
   A.  Arunachal Pradesh
   B.  Nagaland
   C.  Manipur
   D.  Mizoram
   ...
   ''',
    '''
     Q14) Which Indian state had Indiaâ€™s first Muslim Woman Chief Minister?
    A.  Kerala
    B.  Jammu &Kashmir
    C.  Goa
    D.  Assam
   ...
   ''',
    ...
    ''',
    '''
    Q19) Which of these athletes is known by the nickname â€˜Dhing Expressâ€™?
    ...
    ''',
    '''
    Q20) What does the â€˜Râ€™ stand for in the name of Dr B R Ambedkar?
    A.  Ramesh
    B.  Ramakant
    C.  Raman
    D.  Ramji
   ...
   ''',
    ...
    ''',
    '''
    Q27) Who wrote Saraswati Vandana â€œVar de Veenavaadini Var deâ€œ?
   A.  Jaishankar Prasad
